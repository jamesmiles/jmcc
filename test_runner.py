...
APPLE_PHASE1_TESTS = (
    ...
    "positive/phase5/040_implicit_int.c",
    ...
    "positive/phase5/146_sizeof_included_struct.c",
    ...
    "positive/phase5/272_struct_array_macro_expr_size.c",
    "positive/phase5/273_builtin_va_list.c",
    "positive/phase5/274_struct_member_attribute.c",
    "positive/phase5/275_atomic_builtins.c",
    ...
    "positive/phase5/323_uint128_neon_struct_arm64.c",
    ...
    "positive/phase5/329_local_static_ptr_struct_init_arm64.c",
    "positive/phase5/330_array_of_struct_in_struct_global_init_arm64.c",
    "positive/phase5/331_float_times_int_const_global_init_arm64.c",
    ...
    "positive/phase5/342_ptr_diff_add_arm64.c",
    "positive/phase5/343_sizeof_deref_ptr_array_arm64.c",

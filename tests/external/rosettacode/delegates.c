// TEST: rosetta_delegates
// DESCRIPTION: Rosetta Code - Delegates (function pointers in structs, typedef'd struct pointers)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Delegates#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: A stellar vista, Baby.
// STDOUT: Delegator returns default implementation
// STDOUT:
// STDOUT: We're in thing1 with value 3
// STDOUT: A stellar vista, Baby.
// STDOUT: Delegator returns delegate implementation
// STDOUT:
// STDOUT: A stellar vista, Baby.
// STDOUT: Delegator returns default implementation
// STDOUT:

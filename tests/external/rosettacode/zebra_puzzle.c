// TEST: rosetta_zebra_puzzle
// DESCRIPTION: Rosetta Code - Zebra puzzle (compile)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Zebra_puzzle#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: House     Color     Man       Drink     Animal    Smoke     
// STDOUT: 0         Yellow    Norwegian Water     Cats      Dunhill   
// STDOUT: 1         Blue      Dane      Tea       Horse     Blend     
// STDOUT: 2         Red       English   Milk      Birds     PallMall  
// STDOUT: 3         Green     German    Coffee    Zebra     Prince    
// STDOUT: 4         White     Swede     Beer      Dog       BlueMaster

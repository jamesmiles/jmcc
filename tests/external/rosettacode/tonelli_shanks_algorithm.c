// TEST: rosetta_tonelli_shanks_algorithm
// DESCRIPTION: Rosetta Code - Tonelli-Shanks algorithm (wrong_output)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Tonelli-Shanks_algorithm#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: n = 10
// STDOUT: p = 13

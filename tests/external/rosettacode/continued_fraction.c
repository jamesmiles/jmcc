// TEST: rosetta_continued_fraction
// DESCRIPTION: Rosetta Code - Continued fraction (double function pointer callback wrong)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Continued_fraction#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT:  1.414213562
// STDOUT:  2.718281828

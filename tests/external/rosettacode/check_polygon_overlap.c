// TEST: rosetta_check_polygon_overlap
// DESCRIPTION: Rosetta Code - Check if two polygons overlap (VLA in function params)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Check_if_two_polygons_overlap#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: poly1 = { {0, 0}, {0, 2}, {1, 4}, {2, 2}, {2, 0} }
// STDOUT: poly2 = { {4, 0}, {4, 2}, {5, 4}, {6, 2}, {6, 0} }
// STDOUT: poly3 = { {1, 0}, {1, 2}, {5, 4}, {9, 2}, {9, 0} }
// STDOUT:
// STDOUT: poly1 and poly2 overlap? false
// STDOUT: poly1 and poly3 overlap? true
// STDOUT: poly2 and poly3 overlap? true

// TEST: rosetta_jaro_similarity
// DESCRIPTION: Rosetta Code - Jaro similarity (wrong double computation results)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Jaro_similarity#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: 0.944444
// STDOUT: 0.766667

// TEST: rosetta_nested_templated_data
// DESCRIPTION: Rosetta Code - Nested templated data (enum value must be constant integer)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Nested_templated_data#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: [[['Payload#1','Payload#2'],['Payload#3','Payload#4','Payload#1'],'Payload#5']]
// STDOUT: 'Payload#0' unused
// STDOUT: 'Payload#6' unused

// TEST: rosetta_symmetric_difference
// DESCRIPTION: Rosetta Code - Symmetric difference (set operations on string arrays)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Symmetric_difference#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: A \ B:
// STDOUT:   Serena

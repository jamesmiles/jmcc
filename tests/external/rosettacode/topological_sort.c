// TEST: rosetta_topological_sort
// DESCRIPTION: Rosetta Code - Topological sort (wrong_output)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Topological_sort#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: Compile order:
// STDOUT:    [unorderable] cycle_21 cycle_22
// STDOUT:    [unorderable] cycle_11 cycle_12
// STDOUT: 1: std synopsys ieee
// STDOUT: 2: std_cell_lib ramlib dware gtech
// STDOUT: 3: dw02 dw01 dw05 dw06 dw07
// STDOUT: 4: des_system_lib dw03 dw04

// TEST: rosetta_averages_median
// DESCRIPTION: Rosetta Code - Averages/Median (double array qsort SIGSEGV)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Averages/Median#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: flist1 median is    4.85
// STDOUT: flist2 median is    4.60

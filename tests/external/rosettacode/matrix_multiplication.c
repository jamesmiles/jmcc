// TEST: rosetta_matrix_multiplication
// DESCRIPTION: Rosetta Code - Matrix multiplication (restrict, inline, double array ops)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Matrix_multiplication#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: 	  1.000	  0.000	 -0.000
// STDOUT: 	  0.000	  1.000	 -0.000
// STDOUT: 	  0.000	  0.000	  1.000
// STDOUT: 	  0.000	  0.000	  0.000

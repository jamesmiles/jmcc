// TEST: rosetta_reduced_row_echelon_form
// DESCRIPTION: Rosetta Code - Reduced row echelon form (SIGSEGV)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Reduced_row_echelon_form#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: Initial
// STDOUT:        1,   2,  -1,  -4

// TEST: rosetta_reverse_a_string
// DESCRIPTION: Rosetta Code - Reverse a string (wchar, locale, mbstowcs SIGSEGV)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Reverse_a_string#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: abcdef => fedcba
// STDOUT: as⃝df̅ => f̅ds⃝a

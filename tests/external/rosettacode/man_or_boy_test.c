// TEST: rosetta_man_or_boy_test
// DESCRIPTION: Rosetta Code - Man or boy test (compound literals, function pointers, thunks)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Man_or_boy_test#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT: -67

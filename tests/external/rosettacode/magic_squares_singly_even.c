// TEST: rosetta_magic_squares_singly_even
// DESCRIPTION: Rosetta Code - Magic squares of singly even order (wrong output values)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Magic_squares_of_singly_even_order#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: Usage : /tmp/tmpyamhu0x0/g <integer specifying rows in magic square>

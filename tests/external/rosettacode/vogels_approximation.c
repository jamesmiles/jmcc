// TEST: rosetta_vogels_approximation
// DESCRIPTION: Rosetta Code - Vogel's approximation method (2D VLA, transport problem, garbage output)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Vogel%27s_approximation_method#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT:     A   B   C   D   E
// STDOUT: W   0   0  50   0   0
// STDOUT: X  30   0  20   0  10
// STDOUT: Y   0  20   0  30   0
// STDOUT: Z   0   0   0   0  50
// STDOUT:
// STDOUT: Total cost = 3100

// TEST: rosetta_search_a_list_of_records
// DESCRIPTION: Rosetta Code - Search a list of records (struct array search, wrong result)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Search_a_list_of_records#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: 6
// STDOUT: Khartoum-Omdurman
// STDOUT: 4.580000

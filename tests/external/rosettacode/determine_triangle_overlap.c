// TEST: rosetta_determine_triangle_overlap
// DESCRIPTION: Rosetta Code - Determine if two triangles overlap (double comparisons, wrong output)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Determine_if_two_triangles_overlap#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: 1,true
// STDOUT: 1,true

// TEST: rosetta_abbreviations_easy
// DESCRIPTION: Rosetta Code - Abbreviations, easy (size_t, linked list, string ops)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Abbreviations,_easy#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT:  input: riG   rePEAT copies  put mo   rest    types   fup.    6       poweRin
// STDOUT: output: RIGHT REPEAT *error* PUT MOVE RESTORE *error* *error* *error* POWERINPUT

// TEST: rosetta_cartesian_product
// DESCRIPTION: Rosetta Code - Cartesian product of two or more lists (extra chars in output)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Cartesian_product_of_two_or_more_lists#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: Usage : /tmp/tmpxweiof1t/g <Set product expression enclosed in double quotes>

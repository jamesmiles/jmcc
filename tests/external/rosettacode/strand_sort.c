// TEST: rosetta_strand_sort
// DESCRIPTION: Rosetta Code - Sorting algorithms/Strand sort (linked list SIGSEGV)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Sorting_algorithms/Strand_sort#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: before sort:  -2   0  -2   5   5   3  -1  -3   5   5   0   2  -4   4   2 
// STDOUT: after sort:   -4  -3  -2  -2  -1   0   0   2   2   3   4   5   5   5   5 

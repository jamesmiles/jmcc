// TEST: rosetta_magic_squares_doubly_even
// DESCRIPTION: Rosetta Code - Magic squares of doubly even order (wrong values)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Magic_squares_of_doubly_even_order#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: Usage : /tmp/tmpd_ey18uh/g <integer specifying rows in magic square>

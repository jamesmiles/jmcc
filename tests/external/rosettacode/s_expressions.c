// TEST: rosetta_s_expressions
// DESCRIPTION: Rosetta Code - S-expressions (wrong_output)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/S-expressions#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: input is:
// STDOUT: ((data da\(\)ta "quot\\ed data" 123 4.5)
// STDOUT:  ("data" (!@# (4.5) "(mo\"re" "data)")))
// STDOUT: parsed as:
// STDOUT: (
// STDOUT:     (
// STDOUT:         data

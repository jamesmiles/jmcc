// TEST: rosetta_shortest_common_supersequence
// DESCRIPTION: Rosetta Code - Shortest common supersequence (string recursion SIGSEGV)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Shortest_common_supersequence#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: SCS(abcbdab, bdcaba) -> abdcabdab

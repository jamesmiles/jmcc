// TEST: rosetta_history_variables
// DESCRIPTION: Rosetta Code - History variables (compile)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/History_variables#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: current values        : '3', 123, 3.12
// STDOUT: char value history    : [0]  '3', [1]  '2', [2]  '1',
// STDOUT: unsigned value history: [0]  123, [1]   12, [2]    1,
// STDOUT: double value history  : [0] 3.12, [1] 2.31, [2] 1.23,

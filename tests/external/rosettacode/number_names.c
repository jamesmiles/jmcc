// TEST: rosetta_number_names
// DESCRIPTION: Rosetta Code - Number names (string buffer SIGSEGV)
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 5
// SOURCE: https://rosettacode.org/wiki/Number_names#C
// LICENSE: GFDL 1.2
// EXPECTED_STDOUT:
// STDOUT: minus forty-two
// STDOUT: one thousand, nine hundred eighty-four
// STDOUT: ten thousand, 
// STDOUT: one thousand, and twenty-four
// STDOUT: one trillion, one billion, one million, one thousand, and one

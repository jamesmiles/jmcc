// TEST: ctest_00204
// DESCRIPTION: c-testsuite test 00204
// EXPECTED_EXIT: 0
// ENVIRONMENT: hosted
// PHASE: 4
// STDOUT: Arguments:
...
// STDOUT: TUVWXYZ0123
// STDOUT: 456789abcdef
// STDOUT: ghijklmnopqrs
// STDOUT: tuvwxyzABCDEFG
// STDOUT: HIJKLMNOPQRSTUV
// STDOUT: WXYZ0123456789ab
// STDOUT: cdefghijklmnopqrs
// STDOUT: 11.1
// STDOUT: 12.1 12.1
// STDOUT: 13.1 13.2 13.3
// STDOUT: 14.1 14.2 14.3 14.4
// STDOUT: 21.1
// STDOUT: 22.1 22.1
// STDOUT: 23.1 23.2 23.3
// STDOUT: 24.1 24.2 24.3 24.4
// STDOUT: 31.1
// STDOUT: 32.1 32.1
// STDOUT: 33.1 33.2 33.3
// STDOUT: 34.1 34.2 34.3 34.4
// STDOUT: stu ABC JKL TUV 456 ghi
// STDOUT: ABC JKL TUV 456 ghi tuv
// STDOUT: 14.1 14.4 23.1 23.3 32.1 32.2
// STDOUT: 0 14.1 14.4 12 24.1 24.4 345 34.1 34.4
...
// STDOUT: 34.1 34.4
// STDOUT: stdarg:
// STDOUT: ABCDEFGHI ABCDEFGHI ABCDEFGHI ABCDEFGHI ABCDEFGHI ABCDEFGHI
// STDOUT: lmnopqr ABCDEFGHI ABCDEFGHI ABCDEFGHI ABCDEFGHI ABCDEFGHI
// STDOUT: HFA long double:
// STDOUT: 34.1,34.4 34.1,34.4 34.1,34.4 34.1,34.4
// STDOUT: 33.1,33.3 34.1,34.4 34.1,34.4 34.1,34.4
// STDOUT: 32.1,32.2 34.1,34.4 34.1,34.4 34.1,34.4
// STDOUT: 31.1,31.1 34.1,34.4 34.1,34.4 34.1,34.4
// STDOUT: 32.1,32.2 33.1,33.3 33.1,33.3 33.1,33.3 33.1,33.3
// STDOUT: 31.1,31.1 33.1,33.3 33.1,33.3 33.1,33.3 33.1,33.3
// STDOUT: 33.1,33.3 33.1,33.3 33.1,33.3 33.1,33.3
// STDOUT: 34.1,34.4 32.1,32.2 32.1,32.2 32.1,32.2 32.1,32.2
// STDOUT: 33.1,33.3 32.1,32.2 32.1,32.2 32.1,32.2 32.1,32.2
// STDOUT: 34.1,34.4 32.1,32.2 31.1,31.1 31.1,31.1 31.1,31.1 31.1,31.1
// STDOUT: HFA double:
// STDOUT: 24.1,24.4 24.1,24.4 24.1,24.4 24.1,24.4
// STDOUT: 23.1,23.3 24.1,24.4 24.1,24.4 24.1,24.4
// STDOUT: 22.1,22.2 24.1,24.4 24.1,24.4 24.1,24.4
// STDOUT: 21.1,21.1 24.1,24.4 24.1,24.4 24.1,24.4
// STDOUT: 22.1,22.2 23.1,23.3 23.1,23.3 23.1,23.3 23.1,23.3
// STDOUT: 21.1,21.1 23.1,23.3 23.1,23.3 23.1,23.3 23.1,23.3
// STDOUT: 23.1,23.3 23.1,23.3 23.1,23.3 23.1,23.3
// STDOUT: 24.1,24.4 22.1,22.2 22.1,22.2 22.1,22.2 22.1,22.2
// STDOUT: 23.1,23.3 22.1,22.2 22.1,22.2 22.1,22.2 22.1,22.2
// STDOUT: 24.1,24.4 22.1,22.2 21.1,21.1 21.1,21.1 21.1,21.1 21.1,21.1
// STDOUT: HFA float:
// STDOUT: 14.1,14.4 14.1,14.4 14.1,14.4 14.1,14.4
// STDOUT: 13.1,13.3 14.1,14.4 14.1,14.4 14.1,14.4
// STDOUT: 12.1,12.2 14.1,14.4 14.1,14.4 14.1,14.4
// STDOUT: 11.1,11.1 14.1,14.4 14.1,14.4 14.1,14.4
// STDOUT: 12.1,12.2 13.1,13.3 13.1,13.3 13.1,13.3 13.1,13.3
// STDOUT: 11.1,11.1 13.1,13.3 13.1,13.3 13.1,13.3 13.1,13.3
// STDOUT: 13.1,13.3 13.1,13.3 13.1,13.3 13.1,13.3
// STDOUT: 14.1,14.4 12.1,12.2 12.1,12.2 12.1,12.2 12.1,12.2
// STDOUT: 13.1,13.3 12.1,12.2 12.1,12.2 12.1,12.2 12.1,12.2
// STDOUT: 14.1,14.4 12.1,12.2 11.1,11.1 11.1,11.1 11.1,11.1 11.1,11.1
// STDOUT: MOVI:
// STDOUT: 0
// STDOUT: abcd
// STDOUT: abcd0000
// STDOUT: abcd00000000
// STDOUT: abcd000000000000
// STDOUT: ffffabcd
// STDOUT: abcdffff
// STDOUT: ffffffffffffabcd
// STDOUT: ffffffffabcdffff
// STDOUT: ffffabcdffffffff
// STDOUT: abcdffffffffffff
// STDOUT: aaaaaaaa
// STDOUT: 5555555555555555
// STDOUT: 77777777
// STDOUT: 3333333333333333
// STDOUT: f8f8f8f8
// STDOUT: 1e1e1e1e1e1e1e1e
// STDOUT: 3f803f80
// STDOUT: 1ff01ff01ff01ff
// STDOUT: 7fffc0
// STDOUT: 3fff80003fff800
// STDOUT: 7fffffffffe00
// STDOUT: abcd1234
// STDOUT: abcd00001234
// STDOUT: abcd000000001234
// STDOUT: abcd12340000
// STDOUT: abcd000012340000
// STDOUT: abcd123400000000
// STDOUT: ffffffffabcd1234
// STDOUT: ffffabcdffff1234
// STDOUT: abcdffffffff1234
// STDOUT: ffffabcd1234ffff
// STDOUT: abcdffff1234ffff
// STDOUT: abcd1234ffffffff
// STDOUT: ffffef0123456789
// STDOUT: abcdef012345ffff
// STDOUT: abcdef0123456789
// STDOUT: 3e8
// STDOUT: 3e8
// STDOUT: 463
// STDOUT: 36d
// STDOUT: fffffffffffff3e9
// STDOUT: 7b3e8
// STDOUT: 3421
// STDOUT: ffffd3af
// STDOUT: fffffc17
// STDOUT: fffffffffffffc18
// STDOUT: fffffc93
// STDOUT: fffffffffffffc93
// STDOUT: 0
// STDOUT: 3e8
// STDOUT: 3e8
// STDOUT: ffffffff
// STDOUT: 3e8
// STDOUT: fffffffffffffc17
// STDOUT: e0
// STDOUT: 3f8
// STDOUT: 318
// STDOUT: 3e8
